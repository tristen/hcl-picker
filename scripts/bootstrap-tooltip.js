...
!function( $ ) {
  ...
  * ======================== */
  ...
  $.fn.tooltip = function (options) {
    $.fn.tooltip.initWith.call(this, options, Tooltip, 'tooltip')
    return this
  }

  $.fn.tooltip.initWith = function (options, Constructor, name) {
    var tooltip
      , binder
      , eventIn
      , eventOut
    ...
    function get(ele) {
      var tooltip = $.data(ele, name)

      if (!tooltip) {
        tooltip = new Constructor(ele, $.fn.tooltip.elementOptions(ele, options))
        $.data(ele, name, tooltip)
      }
  ...
  $.fn.tooltip.rejectAttrOptions = [ 'title' ]

  $.fn.tooltip.elementOptions = function(ele, options) {
    var data = $(ele).data()
      , rejects = $.fn.tooltip.rejectAttrOptions
      , i = rejects.length
